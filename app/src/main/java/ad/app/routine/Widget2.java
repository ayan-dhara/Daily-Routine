...
public class Widget2 extends AppWidgetProvider {
	...
	public void onReceive(final Context context, Intent Intent) {
		...
		views= new RemoteViews(context.getPackageName(),R.layout.widget2);
	...
	public void update(Context context, RemoteViews remoteViews) {
        AppWidgetManager.getInstance(context).updateAppWidget(new ComponentName(context, Widget2.class), remoteViews);
    }
